...
<div class="topmenu">
    ...
    <?php
		if(isset($_SESSION['logged']))
		{
			echo 'Xin chào bạn, '.$_SESSION['logged'].'&nbsp;&nbsp;<a href="login.php?action=logout">. Đăng xuất</a>';
		}
		else
		{
	...
	<ul>
		...
		if(isset($_SESSION['log']))
		{
			...
			while($row=mysql_fetch_array($query))
			{
				...
				{
					echo '<li><div class="level1icon"></div><a href="administrators.php">User Manager</a></li>';
				}
			}
		}
		else
		...
		if(isset($_SESSION['log']))
		{
			$strSQL1="SELECT * FROM users WHERE id='".$_SESSION['log']."'";
			$query1=mysql_query($strSQL1,$link);
			while($row1=mysql_fetch_array($query1))
			{
				if($row1['RoleID']=='Teacher')
				{
					echo '';
				}
				elseif($row1['RoleID']=='Admin')
				{
					echo '<li><div class="level1icon"></div><a href="categories.php">Category Manager</a></li>';
				}
			}
		}
		else
        ...
        <li><div class="level1icon"></div><a href="userfile.php">UserFile</a></li>
        <li><div class="level1icon"></div><a href="score.php">Score</a></li>
    </ul>
</div>
...
<div class="bottommenu4">
	<ul>
        ...
        <li><div class="level1icon"></div><a href="lessons_readchoose.php">Read fill</a></li>
...
<div class="bottommenu5">
	<ul>
    	...
    	<li><div class="level1icon"></div><a href="key_writeblank.php">__KEY BLANK</a></li>
    	<!--<li><div class="level1icon"></div><a href="">Test Manager</a></li>-->
    </ul>
</div>
<!--<div class="navmenu">
	<ul>
